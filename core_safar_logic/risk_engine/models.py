"""Source-neutral models used by the SAFAR risk and decision subsystems."""
...
class DecisionState(str, Enum):
    """Ordered, non-actuating states emitted by the decision layer."""
...
class HazardDecision:
    """Decision command for the vehicle-control layer."""
